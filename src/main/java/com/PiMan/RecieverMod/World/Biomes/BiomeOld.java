...
public class BiomeOld extends BiomeMaze {
	
	public BiomeOld(BiomeProperties properties) {
		super(properties);
	}
	
	public BiomeOld() {
		super(new BiomeProperties("room_2").setBaseHeight(0F).setHeightVariation(0F).setRainDisabled().setTemperature(0.5F));
