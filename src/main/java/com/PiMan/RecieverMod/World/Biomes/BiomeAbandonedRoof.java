...
public class BiomeAbandonedRoof extends BiomeMaze {
	
	public BiomeAbandonedRoof(BiomeProperties properties) {
		super(properties);
	}
	
	public BiomeAbandonedRoof() {
		super(new BiomeProperties("room_1").setBaseHeight(1F).setHeightVariation(0F).setRainDisabled().setTemperature(0.5F));
		...
		this.roofBlocks.add(Blocks.STONEBRICK.getStateFromMeta(2));
