...
public class ChunkGeneratorReceiver implements IChunkGenerator
{
    protected static final IBlockState STONE = Blocks.STONE.getDefaultState();
    protected static List<IBlockState> FILLER = new ArrayList<IBlockState>();
    ...
    protected final boolean terrainFeaturesEnabled;
    ...
    protected Map<ChunkPos, Entry<BlockPos, WorldGenStructure>> scheduledStructures = new HashMap<ChunkPos, Entry<BlockPos, WorldGenStructure>>();
    ...
    protected MapGenCustomStructureTest customStructureTest = new MapGenCustomStructureTest();
    ...
    public ChunkGeneratorReceiver(World worldIn, long seed, boolean mapFeaturesEnabledIn, boolean terrainFeaturesEnabled, boolean decorate, boolean isFlat, String generatorOptions)
    {
        {
        ...
        this.FILLER.add(Blocks.STONE.getDefaultState());
        this.world = worldIn;
        this.mapFeaturesEnabled = mapFeaturesEnabledIn;
        this.terrainFeaturesEnabled = terrainFeaturesEnabled;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        if (this.isFlat) {
            this.setBlocksInChunkFlat(63, chunkprimer);
        }
        else {
        ...
        this.customStructureTest.generate(this.world, x, z, chunkprimer);
    ...
    public boolean isInsideStructure(World worldIn, String structureName, BlockPos pos)
    {
        ...
        else if ("Tower".equals(structureName) && this.customStructureTest != null)
        {
        	return this.customStructureTest.isInsideStructure(pos);
        }
        else
        {
    ...
    public BlockPos getNearestStructurePos(World worldIn, String structureName, BlockPos position, boolean findUnexplored)
    {
        if (!this.mapFeaturesEnabled)
        {
            return this.customStructureTest.getNearestStructurePos(worldIn, position, findUnexplored);
        }
        else if ("Stronghold".equals(structureName) && this.strongholdGenerator != null)
        {
    ...
    public void recreateStructures(Chunk chunkIn, int x, int z)
    {
        ...
        this.customStructureTest.generate(this.world, x, z, (ChunkPrimer)null);
    }
    
    public void addScheduledStructure(WorldGenStructure generator, BlockPos blockPos, ChunkPos chunkPos) {
    	SimpleEntry<BlockPos, WorldGenStructure> entry = new SimpleEntry<BlockPos, WorldGenStructure>(blockPos, generator);
    	this.scheduledStructures.put(chunkPos, entry);
    }
